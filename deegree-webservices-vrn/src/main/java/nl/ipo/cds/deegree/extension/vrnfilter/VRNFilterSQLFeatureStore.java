...
/**
 * {@link org.deegree.feature.persistence.FeatureStore} implementation that is backed by an SQL database and configured by providing an SQL statement /
 * an SQL connection.
 * 
 * @see org.deegree.feature.persistence.FeatureStore
 * 
...
public class VRNFilterSQLFeatureStore implements FeatureStore {
     ...
     * @param metadata
     */
    public VRNFilterSQLFeatureStore(ConnectionProvider connProvider, String crs, String sql, String ftLocalName,
