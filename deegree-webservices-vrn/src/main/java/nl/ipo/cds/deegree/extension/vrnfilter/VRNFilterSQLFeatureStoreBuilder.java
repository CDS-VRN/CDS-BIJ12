...
import org.deegree.feature.persistence.simplesql.*;
...
/**
 * <code>VRNFilterSQLFeatureStoreBuilder</code>
 * 
...
public class VRNFilterSQLFeatureStoreBuilder implements ResourceBuilder<FeatureStore> {
    ...
    public VRNFilterSQLFeatureStoreBuilder(ResourceMetadata<FeatureStore> metadata, SimpleSQLFeatureStoreConfig config,
                                           Workspace workspace) {
    ...
    public FeatureStore build() {
        ...
        return new org.deegree.feature.persistence.simplesql.SimpleSQLFeatureStore( prov, srs, stmt, name, ns, prefix, bbox, lods, metadata );
    }
