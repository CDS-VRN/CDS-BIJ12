...
insert into manager.thema (id, naam) values 
	((select nextval('manager.hibernate_sequence')), 'Bvb');
	
insert into manager.datasettype (id, naam, thema_id) values
	((select nextval('manager.hibernate_sequence')), 'Bvb', (select id from manager.thema t where t.naam = 'Bvb'));
...
insert into manager.bronhouderthema (thema_id, bronhouder_id) values
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9920') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9921') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9922') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9923') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9924') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9925') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9926') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9927') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9928') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9929') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9930') ),
	( (select id from manager.thema where naam = 'Bvb'), (select id from manager.bronhouder where code = '9931') )	
	;
--
