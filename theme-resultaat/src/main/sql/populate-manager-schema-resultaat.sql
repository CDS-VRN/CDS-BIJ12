...
insert into manager.thema (id, naam) values ((select nextval('manager.hibernate_sequence')), 'Resultaat');
	
insert into manager.datasettype (id, naam, thema_id) values ((select nextval('manager.hibernate_sequence')), 'Zwemwater monsterresultaat', (select id from manager.thema t where t.naam = 'Resultaat'));
...
insert into manager.bronhouderthema (thema_id, bronhouder_id) values
	( (select id from manager.thema where naam = 'Resultaat'), (select id from manager.bronhouder where code = 'zwr') );
--
